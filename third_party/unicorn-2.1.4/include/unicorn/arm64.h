...
typedef enum uc_arm64_reg {
    ...
    UC_ARM64_REG_SPSR_EL1, // hollywood_emu patch: expose SPSR_EL1 (banked_spsr[BANK_SVC])
...
/* hollywood_emu: recompute the ARM generic-timer outputs and update the CPU IRQ
