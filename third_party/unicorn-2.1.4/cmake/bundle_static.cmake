...
function(bundle_static_library tgt_name bundled_tgt_name library_name)
  ...
  # hollywood_emu: use copy instead of create_symlink -- Windows symlink creation
  # needs privilege we don't have, and it made every build report failure even
  # though unicorn.lib was already produced. A copy achieves the same alias.
  add_custom_command(TARGET ${bundled_tgt_name} POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy "$<TARGET_FILE_NAME:${bundled_tgt_name}>" "$<TARGET_FILE_DIR:${bundled_tgt_name}>/$<TARGET_PROPERTY:${bundled_tgt_name},SYMLINK_NAME>"
    WORKING_DIRECTORY "$<TARGET_FILE_DIR:${bundled_tgt_name}>"
  )
endfunction()
